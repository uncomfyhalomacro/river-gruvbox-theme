...
riverctl map normal $mod U spawn "fuzzel -i Papirus -f 'Hasklug Nerd Font' --background=eeeeeeff -t 444444ff -w 60 --selection-color fcdbffff --selection-text-color 444444ff -T $term"
